...
#if defined(PLATFORM_DESKTOP) || defined(PLATFORM_RPI) || defined(PLATFORM_WEB) || defined(PLATFORM_UWP) || defined(PLATFORM_EMBED)
...
#if defined(PLATFORM_ANDROID) || defined(PLATFORM_RPI) || defined(PLATFORM_UWP) || defined(PLATFORM_EMBED)
...
#endif
#if (defined(PLATFORM_DESKTOP) || defined(PLATFORM_EMBED)) && defined(SUPPORT_HIGH_DPI)
...
#if defined(PLATFORM_ANDROID) || defined(PLATFORM_RPI) || defined(PLATFORM_EMBED)
    struct timespec ts;
...
{
    EmbedSizeCallback(width, height);
}
